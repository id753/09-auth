...
## Продовжено роботу над проєктом NoteHub, зосередившись на переходi на новий бекенд з авторизацією, який підтримує: Захищені маршрути, Токени, що зберігаються в куках, Перевірку доступу до даних користувача.

Попереднiй https://github.com/id753/08-zustand
...................................................................................... </br>
Використано новий бекенд з авторизацією, який підтримує:
...
Робота з API. Усі функції для роботи з API розділіть на три файли:
1. для створення одного спільного екземпляра axios, з налаштуванням withCredentials: true для підтримки cookies;
2. для функцій, які викликаються у клієнтських компонентах;
3. для функцій, які викликаються у серверних компонентах.</br>
